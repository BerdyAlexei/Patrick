...
class Patrick(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QIcon(ICO.format('patrick_dark')))
    ...
    def loadFonts(self):
        ...
        self.font_small = QFont(font_family, 7)
    ...
    def mainWidgets(self):
        ...
        self.stored_passwords_content_layout.addItem(QSpacerItem(32, 0, QSizePolicy.Minimum, QSizePolicy.Expanding))
        ...
        for label, text, cursor in [
            (self.generate_letters_clickable_label, 'generate_letters_check_box', Qt.PointingHandCursor),
            (self.generate_accents_clickable_label, 'generate_accents_check_box', Qt.PointingHandCursor),
            (self.generate_uppercase_clickable_label, 'generate_uppercase_check_box', Qt.PointingHandCursor),
            (self.generate_lowercase_clickable_label, 'generate_lowercase_check_box', Qt.PointingHandCursor),
            (self.generate_numbers_clickable_label, 'generate_numbers_check_box', Qt.PointingHandCursor),
            (self.generate_symbols_clickable_label, 'generate_symbols_check_box', Qt.PointingHandCursor),
            (self.password_size_label, 'password_size_label', Qt.ArrowCursor),
            (self.password_colors_label, 'password_colors_label', Qt.ArrowCursor),
            (self.application_colors_label, 'application_colors_label', Qt.ArrowCursor),
            (self.youtube_label, 'youtube_label', Qt.PointingHandCursor),
            (self.github_label, 'github_label', Qt.PointingHandCursor)
        ]:
            label : QLabel
    ...
    def assembleApplication(self, window_group):
        widget_properties = [
            ...
            ('window', self.bar_frame, 'normal', None, WIDTH, WIDGET_HEIGHT, 0, 0),
            ('main', self.information_frame, 'inverted', None, 484, 12, 8, 72),
            ('main', self.fixes_frame, 'normal', None, 484, WIDGET_HEIGHT, 8, 40),
            ...
            ('main', self.stored_passwords_bar_frame, 'normal', None, 484, WIDGET_HEIGHT, 8, 92),
            ('main', self.search_frame, 'inverted', None, 408, 24, 44, 96),
            ('configuration', self.configuration_frame, 'inverted', None, 484, 263, 8, 40),
            ('main', self.prefix_line, 'normal', None, 80, WIDGET_HEIGHT, 8, 40),
            ('configuration', self.password_size_frame, 'normal', None,  226, 24, 258, 49),
            ('configuration', self.password_size_line_frame, 'inverted', None, 52, 16, 427, 53),
            ('configuration', self.password_colors_frame, 'normal', None,  226, 24, 258, 81),
            ('configuration', self.application_colors_frame, 'normal', None, 226, 24, 258, 113),
            ('configuration', self.youtube_frame, 'normal', None, 226, 24, 258, 177),
            ('configuration', self.github_frame, 'normal', None, 226, 24, 258, 208),
            ...
            ('configuration', self.generate_letters_check_box, 'configuration_window', None, 226, 24, 16, 48),
            ('configuration', self.generate_accents_check_box, 'configuration_window', None, 226, 24, 16, 80),
            ('configuration', self.generate_uppercase_check_box, 'configuration_window', None, 109, 24, 16, 112),
            ('configuration', self.generate_lowercase_check_box, 'configuration_window', None, 109, 24, 133, 112),
            ('configuration', self.generate_numbers_check_box, 'configuration_window', None, 226, 24, 16, 144),
            ('configuration', self.generate_symbols_check_box, 'configuration_window', None, 226, 24, 16, 176),
            ('configuration', self.generate_custom_text_check_box, 'configuration_window', None, 226, 89, 16, 207),
            ('configuration', self.generate_custom_text_clickable_label, None, None, 226, 24, 16, 207),
            ('configuration', self.custom_text_plain, 'inverted', None, 210, 56-2, 24, 234),
            ('window', self.title_label, 'normal', 'title', GRAB_WIDTH, GRAB_HEIGHT, 0, 0),
            ('configuration', self.generate_letters_clickable_label, None, None, 226, 24, 16, 48),
            ('configuration', self.generate_accents_clickable_label, None, None, 226, 24, 16, 80),
            ('configuration', self.generate_uppercase_clickable_label, None, None, 109, 24, 16, 112),
            ('configuration', self.generate_lowercase_clickable_label, None, None, 109, 24, 133, 112),
            ('configuration', self.generate_numbers_clickable_label, None, None, 226, 24, 16, 144),
            ('configuration', self.generate_symbols_clickable_label, None, None, 226, 24, 16, 176),
            ...
            ('configuration', self.exit_configuration_button, 'normal', None, 226, 24, 258, 145),
            ('configuration', self.youtube_button, None, None, 226, 24, 258, 177),
            ('configuration', self.github_button, None, None, 226, 24, 258, 208)
        ]
        if window_group == 'register' or window_group == 'login':
            widget_properties += [
                ('login', self.login_frame, 'inverted', 'top_rounded', 242, 94, 129, 109),
                ('login', self.enter_key_frame, 'normal', None, 226, 46, 137, 117),
                ('login', self.key_line_frame, 'inverted', None, 218, 16, 141, 143),
                ('login', self.key_line, 'inverted', None, 218, 16, 141, 143),
                ('login', self.key_label, 'normal', None, 226, 26, 137, 117),
                ('login', self.submit_key_button, 'application_disabled', None, 226, 24, 137, 171)
            ]

            if window_group == 'register':
                widget_properties += [
                    ('register', self.advice_frame, 'inverted', None, 242, 200, 129, 69),
                    ('register', self.register_frame, 'normal', None, 226, 88, 137, 77),
                    ('register', self.create_key_line_frame, 'inverted', None, 218, 16, 141, 103),
                    ('register', self.confirm_key_line_frame, 'inverted', None, 218, 16, 141, 145),
                    ...
                    ('register', self.continue_button, 'application_disabled', None, 226, 24, 137, 173),
    ...
    def setAndColorizeIcon(self):
        ...
        for widget, icon, alternative_icon, color, enabled in [
            ...
            widget.setIconSize(QSize(WIDGET_WIDTH, WIDGET_HEIGHT))
        ...
        self.youtube_image_label.setPixmap(QPixmap(self.changeSVGColor(
            ...
            ).scaledToWidth(28, Qt.SmoothTransformation)
        )
        ...
        self.application_color_default.setIconSize(QSize(16, 16))
        self.password_color_default.setIconSize(QSize(16, 16))
    ...
    def generateStoredPasswordsList(self, search = False, filtered_dictionary = None):
        ...
        stored_passwords = self.keysNormalizer(stored_passwords)

        stored_passwords_length = len(stored_passwords.keys())

        for index in range(stored_passwords_length):
            self.createStoredPassword(stored_passwords[f'{index}'], index, search)
    ...
    def createStoredPassword(self, stored_password, index, search = False):
        colors = {
        ...
        stored_password_frame.setFixedHeight(32)
        ...
        def updateStoredPassword():
            ...
            self.stored_passwords[f'{self.real_key_list[index] if search else index}'] = stored_password
        ...
        stored_password_background_color_button.setFixedSize(16, 16)
        stored_password_letter_color_button.setFixedSize(16, 16)
        delete_stored_password_button.setFixedSize(WIDGET_WIDTH, WIDGET_HEIGHT)
        
        stored_password_grid_layout_widget = QWidget()
        stored_password_grid_layout_widget.setFixedSize(32, 32)

        stored_password_grid_layout = QGridLayout(stored_password_grid_layout_widget)
        stored_password_grid_layout.setContentsMargins(3, 3, 10, 10)
        ...
        delete_stored_password_button.setIconSize(QSize(WIDGET_WIDTH, WIDGET_HEIGHT))

        def deleteStoredPassword():
            del self.stored_passwords[f'{self.real_key_list[index] if search else index}']

            if search:
                self.searchStoredPassword()
        ...
        stored_password_line.setFixedHeight(18)
        stored_information_line.setFixedHeight(14)
        ...
        def copy_visual_feedback():
            ...
            copied_frame.setFixedSize(96, 20)
            ...
            copied_label.setFixedSize(96, 20)

            horizontal_position = (stored_password_frame.size().width() / 2) - 48
            vertical_position = (stored_password_frame.size().height() / 2) - 10
    ...
    def grabTolerance(self):
        try:
            if not (self.cursor_horizontal < GRAB_WIDTH and self.cursor_vertical < GRAB_HEIGHT):
                return False
        except:
            return False
